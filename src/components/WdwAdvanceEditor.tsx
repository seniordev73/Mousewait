...
import { fetchByComposerEditorWdw, composerPost } from '../redux/lounges/slice';
...
function WdwAdvanceEditor({LoungeId, register, setValue} : MwAdvanceEditorProps) {
  type FormData = {
    edit_chat_msg: any;
    file: any;
    youtubelink: any;
  ...
  const loadDataOnlyOnce = () => {
    dispatch(fetchByComposerEditorWdw({ LoungeId })).then((res: any) => {
...
export default WdwAdvanceEditor;
